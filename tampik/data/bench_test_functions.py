...
data_functions = {
    ...
    'Ackley N. 2':{
        ...
        'fix_dimension': 2,
        'latex_dimension':'d=2',
        'input_domain':lambda: np.array([[-32, 32], [-32, 32]]),
    ...
    'Adjiman':{
        ...
        'fix_dimension': 2,
        'latex_dimension':'d=2',
        'input_domain':lambda:np.array([[-1, 2], [-1, 1]]),
    ...
    'Bartels':{
        ...
        'input_domain':lambda:np.array([[-500, 500], [-500, 500]]),
    ...
    'Beale':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-4.5, 4.5], [-4.5, 4.5]]),
    ...
    'Bird':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-2 * np.pi, 2 * np.pi], [-2 * np.pi, 2 * np.pi]]),
    ...
    'BohachevskyN1':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-100, 100], [-100, 100]]),
    ...
    'BohachevskyN3':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-50, 50], [-50, 50]]),
    ...
    'Booth':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-10, 10], [-10, 10]]),
    ...
    'Branin':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-5, 10], [0, 15]]),
    ...
    'Brent':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-20, 0], [-20, 0]]),
    ...
    'BukinN6':{
        ...
        'fix_dimension': 2,
        'latex_dimension':r'd=2',
        'input_domain':lambda:np.array([[-15,-5],[-3, 3]]),
